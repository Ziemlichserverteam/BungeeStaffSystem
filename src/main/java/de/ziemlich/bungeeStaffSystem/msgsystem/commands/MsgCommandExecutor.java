...
public class MsgCommandExecutor extends Command {

    public MsgCommandExecutor(String name, String permission, String... aliases) {
    ...
    public void execute(CommandSender s, String[] args) {
        ...
        if(args.length < 2) {
            s.sendMessage(new TextComponent("§cUse /msg <player> <message...>"));
            return;
        }
        ...
        if(receiver.getUniqueId() == sender.getUniqueId()) {
            sender.sendMessage(new TextComponent("§cDu kannst dir selber nicht schreiben."));
            return;
        }
