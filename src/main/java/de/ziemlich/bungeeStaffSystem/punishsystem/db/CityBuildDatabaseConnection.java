...
public class CityBuildDatabaseConnection {
    ...
    public CityBuildDatabaseConnection(HashMap<String, String> config) {
    ...
    public void connect() {
        if(!isConnected()) {
            try {
                con = DriverManager.getConnection("jdbc:mysql://" + host + ":" + port + "/" + "cbreal" + "?autoReconnect=true", username, password);
